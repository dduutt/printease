...
<template>
  <el-table :data="datas" size="default" :border="true" :stripe="stripe" :showSum="showSum" ref="tableRef"
    :height="height" :max-height="maxHeight" :span-method="spanMethod" :row-key="rowKey" v-loading="loading"
    ...
    :element-loading-text="loadingTxt" style="width: 100%;">
    <slot></slot>
  </el-table>
</template>
